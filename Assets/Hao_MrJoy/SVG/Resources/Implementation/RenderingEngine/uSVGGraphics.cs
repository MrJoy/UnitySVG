...
public class uSVGGraphics {
  ...
  private uSVGGraphicsFill _graphicsFill;
  private uSVGGraphicsStroke _graphicsStroke;
  ...
  //================================================================================
  public uSVGGraphics() {
    this._graphicsFill = new uSVGGraphicsFill(this);
    this._graphicsStroke = new uSVGGraphicsStroke(this);
  }
  //-----
