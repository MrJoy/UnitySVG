...
public class SVGGraphics
{
	...
	public void SetSize(float width, float height)
	{
		_width = (int) width;
		_height = (int) height;
		_device.SetDevice(_width, _height);
		_graphicsFill.SetSize((int) width, (int) height);
		Clean();
	}
		...
		SVGGraphicsPath graphicsPath)
	{
		...
		if ((int) width == 1)
			_graphicsFill.FillPath(linearGradientBrush, strokePathColor, graphicsPath);
		else _graphicsFill.FillPath(linearGradientBrush, graphicsPath);
		...
		SVGGraphicsPath graphicsPath)
	{
		...
		if ((int) width == 1)
			_graphicsFill.FillPath(radialGradientBrush, strokePathColor, graphicsPath);
		else _graphicsFill.FillPath(radialGradientBrush, graphicsPath);
	...
	{
		_graphicsFill.FillPath(fillColor, strokePathColor, graphicsPath);
		if ((int) width == 1) _graphicsFill.FillPath(fillColor, strokePathColor, graphicsPath);
		else _graphicsFill.FillPath(fillColor, graphicsPath);
