...
public class uSVGBasicDraw {
  ...
  //================================================================================
  private uSVGPoint _currentPoint;
  ...
  public uSVGBasicDraw() {
    this._currentPoint = new uSVGPoint(0f, 0f);
  }
  //================================================================================
  //--------------------------------------------------------------------------------
  //Methods: Swap
  ...
  public void Arc(uSVGPoint p1, float rx, float ry, float angle,
    ...
    uSVGPoint _point = new uSVGPoint(0, 0);
    float t_angle;
    for(int i = 0; i <= number; i++) {
      t_angle = (deltaT * i + _angle)* Mathf.PI / 180.0f;
      _point.x = _CosRadian * rx *(float)Math.Cos(t_angle)-
            _SinRadian * ry *(float)Math.Sin(t_angle)
            + cx;
      _point.y = _SinRadian * rx *(float)Math.Cos(t_angle)+
  ...
  public void ArcTo(float r1, float r2, float angle,
        bool largeArcFlag, bool sweepFlag,
        uSVGPoint p) {
    uSVGPoint _tempPoint = new uSVGPoint(this._currentPoint.x, this._currentPoint.y);
  ...
  private int NumberOfLimitForCubic(uSVGPoint a, uSVGPoint b, uSVGPoint c, uSVGPoint d) {
    ...
    if((_r1 * _r2) > 0)return 0; else return 1;
  }
  ...
  private uSVGPoint EvaluateForCubic(float t, uSVGPoint p1, uSVGPoint p2, uSVGPoint p3, uSVGPoint p4) {
    uSVGPoint _return = new uSVGPoint(0, 0);
  ...
  private void CubicCurve(uSVGPoint p1, uSVGPoint p2, uSVGPoint p3, uSVGPoint p4, int numberOfLimit, EvaluateDelegate evalFunction) {
    ...
    uSVGPointExt _pStart, _pEnd, _pMid;
    _pStart = new uSVGPointExt(evalFunction(t1, p1, p2, p3, p4), t1);

    _pEnd = new uSVGPointExt(evalFunction(t2, p1, p2, p3, p4), t2);

    // The point on Line Segment[_pStart, _pEnd] correlate with _t

    LiteStack<uSVGPointExt> _stack = new LiteStack<uSVGPointExt>();
    _stack.Push(_pEnd); //Push End Point into Stack

    //Array of Change Point
    uSVGPointExt[] _limitList = new uSVGPointExt[_limit + 1];
    ...
    while(true) {
      ...
      _pMid = new uSVGPointExt(evalFunction(_tm, p1, p2, p3, p4), _tm);

      //Calculate Distance from Middle Point to the Flatnet
      float dist = Distance(  _pStart.point,
                 ((uSVGPointExt)_stack.Peek()).point,
                  _pMid.point);
      ...
      if(dist < _flatness) {
        ...
        for(i = 0; i < _limit; i++) {
          ...
          uSVGPointExt _q = new uSVGPointExt(evalFunction(mm, p1, p2, p3, p4), mm);
          _limitList[i] = _q;
