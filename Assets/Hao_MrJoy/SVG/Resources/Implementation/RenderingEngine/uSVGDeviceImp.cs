...
public class uSVGDeviceImp:uISVGDevice {
	...
	/***********************************************************************************/
	public uSVGDeviceImp() {
	}
	public uSVGDeviceImp(float width, float height) {
		f_SetDevice( (int)width, (int)height);
	}
	public uSVGDeviceImp(int width, int height) {
		f_SetDevice(width, height);
	}
	/***********************************************************************************/
