public class uSVGLengthConvertor  {
	/***********************************************************************************/
	public static bool f_ExtractType (string text, ref float value, ref uSVGLengthType lengthType) {
		string m_value = "";
		string unit = "";
		int i;
		text = text.Replace(" ", "");
	...
	/***********************************************************************************/
	public static float f_ConvertToPX(float value, uSVGLengthType lengthType) {
		switch (lengthType) {
