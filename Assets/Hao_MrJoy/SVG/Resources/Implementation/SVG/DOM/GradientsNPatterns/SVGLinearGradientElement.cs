...
{
	private readonly SVGLength _x1;
	private readonly SVGLength _y1;
	private readonly SVGLength _x2;
	private readonly SVGLength _y2;
	...
	public SVGLinearGradientElement(SVGParser xmlImp, Dictionary<string, string> attrList)
